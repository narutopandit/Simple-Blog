...
const CreateButton = ({onClick}:{onClick:(e:any)=>void}) => {
  return (
    <div>
         <button className={`flex items-center gap-2 px-4 py-2 text-white font-semibold 
            ...
            <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><path d="M12 19v-7m0 0V5m0 7H5m7 0h7"></path></svg>
            Create
            </button>
    </div>
  )
